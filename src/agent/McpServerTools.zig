//! Agent MCP tool implementations — the dispatch adapters (`call*`),
//! tool bodies (`tool*`), key/JSON helpers, and inline tests for
//! McpServer. Split out of McpServer.zig (which now holds only
//! socket lifecycle + dispatch wiring). Each `call*` unpacks the
//! JSON params and delegates to its `tool*`; the `dispatch_table`
//! in McpServer.zig routes by index to the `pub` `call*` adapters
//! here. `self` is always the owning `*McpServer`.
...
pub fn callReadOutput(self: *McpServer, params: []const u8, buf: []u8, id: ?[]const u8) []const u8 {
...
pub fn callGetGraph(self: *McpServer, params: []const u8, buf: []u8, id: ?[]const u8) []const u8 {
    _ = params;
    return toolGetGraph(self, buf, id);
}
pub fn callSendInput(self: *McpServer, params: []const u8, buf: []u8, id: ?[]const u8) []const u8 {
    const pane_id = tools.extractNestedJsonInt(params, "pane_id") orelse
        return tools.jsonRpcError(buf, id, -32602, "Missing pane_id");
    const text = tools.extractNestedJsonString(params, "text") orelse
        return tools.jsonRpcError(buf, id, -32602, "Missing text");
    return toolSendInput(self, pane_id, text, buf, id);
}
pub fn callCreatePane(self: *McpServer, params: []const u8, buf: []u8, id: ?[]const u8) []const u8 {
    ...
    return toolCreatePane(self, @intCast(workspace), is_horizontal, command, cwd, buf, id);
}
...
pub fn callSendKeys(self: *McpServer, params: []const u8, buf: []u8, id: ?[]const u8) []const u8 {
    const pane_id = tools.extractNestedJsonInt(params, "pane_id") orelse
        return tools.jsonRpcError(buf, id, -32602, "Missing pane_id");
    return toolSendKeys(self, pane_id, params, buf, id);
}
pub fn callGetState(self: *McpServer, params: []const u8, buf: []u8, id: ?[]const u8) []const u8 {
    const pane_id = tools.extractNestedJsonInt(params, "pane_id") orelse
        return tools.jsonRpcError(buf, id, -32602, "Missing pane_id");
    return toolGetState(self, pane_id, buf, id);
}
pub fn callFocusPane(self: *McpServer, params: []const u8, buf: []u8, id: ?[]const u8) []const u8 {
    const pane_id = tools.extractNestedJsonInt(params, "pane_id") orelse
        return tools.jsonRpcError(buf, id, -32602, "Missing pane_id");
    return toolFocusPane(self, pane_id, buf, id);
}
pub fn callClosePane(self: *McpServer, params: []const u8, buf: []u8, id: ?[]const u8) []const u8 {
    const pane_id = tools.extractNestedJsonInt(params, "pane_id") orelse
        return tools.jsonRpcError(buf, id, -32602, "Missing pane_id");
    return toolClosePane(self, pane_id, buf, id);
}
...
pub fn callGetConfig(self: *McpServer, params: []const u8, buf: []u8, id: ?[]const u8) []const u8 {
    _ = params;
    return toolGetConfig(self, buf, id);
}
pub fn callSessionSave(self: *McpServer, params: []const u8, buf: []u8, id: ?[]const u8) []const u8 {
...
pub fn callSessionRestore(self: *McpServer, params: []const u8, buf: []u8, id: ?[]const u8) []const u8 {
    const name = tools.extractNestedJsonString(params, "name") orelse
        return tools.jsonRpcError(buf, id, -32602, "Missing name");
    return toolSessionRestore(self, name, buf, id);
}
pub fn callScreenshot(self: *McpServer, params: []const u8, buf: []u8, id: ?[]const u8) []const u8 {
...
fn toolListPanes(self: *McpServer, buf: []u8, id: ?[]const u8) []const u8 {
    ...
    for (self.multiplexer.panes.items, 0..) |*pane, i| {
        ...
        const proc_name = findPaneName(self, pane.id);
        ...
        const workspace = findPaneWorkspace(self, pane.id);
