...
## Version
Current: 0.3.7. Single source of truth: `build.zig` (line 10). Propagated via `build_options.version` to main.zig and McpServer.zig at compile time. Bump with: `make bump-version V=x.y.z` (updates build.zig + build.zig.zon)
